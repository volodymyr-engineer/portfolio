...
export const ValueCard = (props: Props) => (
	<div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:group-hover/list:opacity-50 lg:hover:!opacity-100">
		...
		<div className="z-10 sm:order-2 sm:col-span-6 sm:m-auto">
		...
		<svg
			className="hidden aspect-video rounded border-2 border-slate-200/10 transition group-hover:border-slate-200/30 group-hover:text-slate-200 sm:order-1 sm:col-span-2 sm:block sm:translate-y-1"
			aria-hidden="true"
		>
